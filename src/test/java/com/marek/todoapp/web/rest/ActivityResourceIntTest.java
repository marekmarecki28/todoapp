...
import com.marek.todoapp.domain.Activity;
import com.marek.todoapp.repository.ActivityRepository;
...
import static com.marek.todoapp.web.rest.TestUtil.createFormattingConversionService;
...
public class ActivityResourceIntTest {
    ...
    public void createActivity() throws Exception {
        ...
        assertThat(testActivity.getText()).isEqualTo(DEFAULT_TEXT);
    }
    ...
    public void updateActivity() throws Exception {
        ...
        Activity testActivity = activityList.get(activityList.size() - 1);
        assertThat(testActivity.getText()).isEqualTo(UPDATED_TEXT);
    }
